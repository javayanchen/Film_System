...
<div class="container-fluid">
    <%--题头--%>
    <h3 style="text-align: center">电影管理列表</h3>
    ...
    <div style="float: left;">
        <form class="form-inline" action="#" method="post">
            ...
            <div class="form-group">
                <label for="sports">电影名称</label>
                <input type="text" name="name" value="" class="form-control" id="movies">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="/admin/film/addFilm.jsp?typeId=5">添加</a>
