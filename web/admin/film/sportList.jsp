...
<div class="container-fluid">
    <%--题头--%>
    <h3 style="text-align: center">体育视频管理列表</h3>
    ...
    <div style="float: left;">
        <form class="form-inline" action="#" method="post">
            ...
            <div class="form-group">
                <label for="sports">体育视频名称</label>
                <input type="text" name="name" value="" class="form-control" id="sports">
            </div>

            <div class="form-group">
                <label for="director">导演</label>
                <input type="text" name="address" value="" class="form-control" id="director">
            </div>
    ...
    <div style="float: right;margin: 5px;">
        <a class="btn btn-primary" href="/admin/film/addFilm.jsp?typeId=6">添加</a>
...
<script>
    ...
    function loadData(index) {
        var filmName = $("#sports").val();
        var filmAuthor = $("#director").val();
        $.getJSON("/filmServlet", {pageindex: index, filmName: filmName, filmAuthor: filmAuthor, typeID: "6"}, function (data) {
            var str = "";
